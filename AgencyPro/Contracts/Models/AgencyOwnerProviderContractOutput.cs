...
{
    [FlowDirective(FlowRoleToken.AgencyOwner, "contracts/provider-contracts")]
    public class AgencyOwnerProviderContractOutput : ProviderContractOutput
    {
        ...
        public override string ProjectManagerEmail { get; set; }
        public override string ProjectManagerPhoneNumber { get; set; }
        ...
        public override string AccountManagerEmail { get; set; }
        public override string AccountManagerPhoneNumber { get; set; }
